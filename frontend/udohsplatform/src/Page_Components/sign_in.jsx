...
const Sign_In = ({
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#020617] h-full fixed w-full overflow-auto max-w-[700px] min-[600px]:p-6 shadow-[0px_5px_15px_rgba(0,0,0,0.35)] dark:shadow-[rgba(255,255,255,0.089)_0px_0px_7px_5px]">
