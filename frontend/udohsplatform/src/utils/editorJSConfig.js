...
const editorJSConfiguration = (data) => {
  return {
    holder: "editorJS",
  ...
  blocks: [
    {
      ...
      type: "paragraph",
      data: {
        text: 'The <b>bold </b><i>italic </i><a href="http://tenece.com">link </a><q class="cdx-inline-quote">quote</q>&nbsp; <code class="inline-code">code </code>&nbsp;<u class="cdx-underline">underline</u>',
      },
    },
  ],
  version: "2.28.0",
